...
_SUBAGENT_CTX = _Unattended(
    "subagent", "subagent_mode", "subagents run without a user present to approve it",
    "in subagents", "this subagent run is intentionally trusted",
)
...
def _unattended_contexts() -> list[_Unattended]:
    ...
    if _is_subagent_context():
        contexts.append(_SUBAGENT_CTX)
