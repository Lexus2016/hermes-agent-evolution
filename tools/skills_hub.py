...
from tools.skills_hub_models import SkillMeta, _normalize_lock_install_path, _validate_skill_name
...
_retrieval_events_file = _path_resolver("RETRIEVAL_EVENTS_FILE", "SKILLS_DIR", "retrieval_events.jsonl")
_DYNAMIC_PATH_RESOLVERS = {"HERMES_HOME": _hermes_home, **{
    r.__name__[1:].upper(): r
    for r in (_skills_dir, _hub_dir, _lock_file, _quarantine_dir, _audit_log, _taps_file, _index_cache_dir, _retrieval_events_file)
}}
