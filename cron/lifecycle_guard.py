...
def _resolve_terminal_script_path(candidate: str, cwd: Optional[str] = None) -> Optional[Path]:
    """Resolve a terminal script path candidate, returning None on invalid/null-byte paths."""
    paths = list(_resolved_or_nothing(candidate, cwd))
