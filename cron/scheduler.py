...
# Defined EARLY (moved from near the bottom of the module) so partial/deferred
# module loads can never hit NameError on the call site in _run_job_impl
# (same defect class as _LAST_RUN_TOOL_CALLS, #cron-fix).
