...
_BRANCH_COPY_KEYS = ("content", "origin", "tool_calls", "tool_call_id", "reasoning", "reasoning_details",
...
class CLICommandsMixin:
    ...
    def _handle_verify_command(self, cmd_original: str = ""):
