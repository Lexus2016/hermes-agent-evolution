...
class CLIChatTurnMixin:
    ...
    def chat(self, message, images: list = None, voice_input: bool = False) -> Optional[str]:
        ...
        from cli import _get_cron_failure_digest_for_user
        ...
        turn = _ChatTurn()
        turn._cron_failure_digest = _cron_failure_digest
        try:
    ...
    def _chat_run_agent(self, turn, message):
        ...
        if getattr(turn, "_cron_failure_digest", None):
            agent_message = _prepend_note_to_message(agent_message, turn._cron_failure_digest)
