...
class TestMem0WriteMetadata:
    ...
    def test_add_tool_passes_channel_metadata(self):
        ...
        # Metadata now also carries temporal validity fields (#1289); assert
        # the channel tag is present rather than exact-dict equality.
    ...
    def test_sync_turn_passes_channel_metadata(self):
        ...
        assert "valid_from" in adds[-1][2]["metadata"]
