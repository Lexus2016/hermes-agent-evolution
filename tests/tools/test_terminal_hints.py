...
class TestTerminalIntegration:
    ...
    def test_hint_field_wired(self):
        ...
        # simulate: interpret gives None, hints give a value. Exit 127 now has a
        # shell-level note (#1452); use a code with no semantic table entry.
        note = terminal_tool_result._interpret_exit_code("python x.py", 3)
        assert note is None
