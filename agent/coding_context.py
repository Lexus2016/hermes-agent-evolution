...
CODING_AGENT_GUIDANCE = (
    ...
    "- Before exploring an unfamiliar codebase, call `repo_map` FIRST — when it "
    "is in your toolset and the codebase is Python (it is Python-only) — to get "
    ...
    "specific files you need. Without `repo_map`, start from `search_files`.\n"
