...
_REASONING_STALE_TIMEOUT_FLOORS: dict[int, tuple[str, ...]] = {
    ...
    300: (
        ...
        "ox-alpha", "x-preview-f-free", "inkling", "deepseek-v4-pro",
    ),
    ...
    180: ("qwen3", "claude-sonnet-5", "claude-sonnet-4.5", "claude-sonnet-4.6", "grok-4-fast-non-reasoning", "deepseek-flash", "deepseek-v4-flash", "deepseek-v4.1-flash", "deepseek-v4-flash-free"),
}
