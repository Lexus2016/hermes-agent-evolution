...
from agent.fallback_cooldown import FailoverReason
...
def _arm_fallback_restart(agent, api_messages, active_system_prompt, _retry):
    ...
    # PREVIOUS provider; after failover the new provider starts fresh.
...
def _run_conversation_turn(
    ...
    if moa_config is None:
        _preflight_result = _preflight_model_validation_result(agent, s.messages)
...
_run_conversation_impl = _run_conversation_turn

__all__ = ["run_conversation", "_run_conversation_impl"]
