...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        # NOTE (upstream sync #562): Content-addressed (instructions + tools) within a logical scope
        # that survives compression rotation; session_id itself stays untouched for transcript isolation.
