...
def _maybe_inject_iteration_budget_warning(agent: Any, messages: Any) -> bool:
    ...
    max_total = getattr(budget, "max_total", None)
...
def begin_iteration(
    ...
    final_response: Any = None, failed: bool = False,
) -> IterationStart:
