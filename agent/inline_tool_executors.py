...
def _memory(agent, args: dict, ctx: InlineToolContext) -> Any:
    ...
    if _mem_breaker.should_trip():
        ...
        return json.dumps({"success": False, "error": _mem_msg}, ensure_ascii=False)
...
INLINE_TOOL_EXECUTORS: Dict[str, InlineToolExecutor] = {
    ...
    "compact_context": lambda agent, args, ctx: __import__("tools.compact_context_tool", fromlist=["compact_context_tool"]).compact_context_tool(
