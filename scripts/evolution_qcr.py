...
_ENV_TOOL_ALIASES: Dict[str, str] = {
    "terminal": "terminal", "browser_navigate": "browser_navigate",
    "docker": "terminal", "ssh": "terminal",
}
...
def check_reuse_guardrail(
    ...
    *,
    ...
    if any("same environment" in c.lower() for c in n.applicability_conditions):
        env_missing = sorted({
            alias for tool, alias in _ENV_TOOL_ALIASES.items()
    ...
    return {
        ...
        "unresolved_bindings": [
            b for b in n.bindings_to_obtain
