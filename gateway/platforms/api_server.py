...
class APIServerAdapter(OpenAICompatRoutesMixin, BasePlatformAdapter):
    ...
    async def _run_agent(
        ...
        session_history_delivery: str = "", turn_author: Optional[Dict[str, Any]] = None, persist_user_origin: Optional[str] = "api") -> tuple:
            ...
            with self._profile_scope(request_profile):
                ...
                try:
                    ...
                    result = agent.run_conversation(
                        ...
                        task_id=effective_task_id, persist_user_origin=persist_user_origin, **author_kwargs)
