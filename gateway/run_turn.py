...
class GatewayTurnMixin:
    ...
    def _hmwa_user_transcript_entry(event, prepared, ts):
        ...
        if getattr(prepared, "persist_user_origin", None):
            _user_entry["origin"] = prepared.persist_user_origin
    ...
    async def _hmwa_prepare_turn(self, event, source, session_entry, session_key, _quick_key, run_generation):
        ...
        _platform_value = getattr(source.platform, "value", str(source.platform))
        ...
        return self._PreparedTurn(
            ...
            persist_user_display_kind, session_entry.session_id, owner, persist_user_origin,
        ), _session_env_tokens
    ...
    async def _handle_message_with_agent(self, event, source, _quick_key: str, run_generation: int):
        ...
        try:
            ...
            agent_result = await self._run_agent(
                ...
                persist_user_origin=prepared.persist_user_origin,
